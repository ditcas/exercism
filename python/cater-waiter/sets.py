...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category_name, category_value in CATEGORIES.items():
        if unique_dish_ingredients.issubset(category_value): # és de la categoria si tots els seus ingredients estan en aquesta categoria. Tots els dish pertanyen a una i només a una.
